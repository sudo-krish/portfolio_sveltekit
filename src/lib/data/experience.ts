...
export const experienceData = {
    ...
    content: {
        shortDescription: `My engineering journey spans from building foundational <strong class="text-foreground font-medium">Hadoop & ETL pipelines</strong> to architecting <span class="text-blue-400 font-medium tracking-wide">petabyte-scale, real-time data platforms</span>.`,
