...
export const codingStatsData = {
    ...
    philosophy: {
        ...
        detailedPhilosophy: `I maintain a rigorous focus on <span class="text-[#ffa116] font-medium">Data Structures and Algorithms (DSA)</span> via LeetCode to ensure my core engineering fundamentals—from performance tuning to optimized complexity—remain razor-sharp. Simultaneously, I channel my creativity into <span class="text-[#22c55e] font-medium">data engineering & systems architecture</span> on GitHub. I build and document real-world projects involving modern cloud data warehouses, real-time message brokers like Kafka, data lakes, and robust ETL/ELT pipelines capable of handling massive throughput.`
    },
    ui: {
        carousel: {
