...
export const sectionContent: Record<string, SectionContent> = {
    ...
    techstack: {
        ...
        slug: "/tech-stack",
        seoTitle:
            "Modern Data Stack | AWS, Kafka, Iceberg, Redshift & dbt | Krishnanand Anil",
        seoDescription:
            "Architect-level tech stack: AWS (EMR, Glue, Redshift), Apache Kafka, Iceberg, Delta Lake, Z-Ordering, dbt, Airflow, Soda, and AI-integrated data foundations (Embeddings, RAG).",
        seoKeywords: [
            "modern data stack 2025",
            "Apache Iceberg Z-Ordering",
            "AWS Redshift performance tuning",
            "Python PySpark developer",
            "Apache Airflow & dbt",
            "Soda Great Expectations SEO",
            "vector embeddings data pipeline",
            "RAG architecture data engineer",
            "distributed SQL TiDB",
    ...
    impact: {
        ...
        slug: "/impact",
        seoTitle:
            "Quantified Impact | 99% Latency Reduction & 80% ETL Automation",
        seoDescription:
            "Measurable results: 50M+ daily events processed with 99% latency reduction, 80% reporting effort cut via automated dbt/Airflow workflows, and 98% data accuracy with Soda/GE.",
        seoKeywords: [
