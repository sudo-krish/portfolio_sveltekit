<script lang="ts">
  ...
  const deepColor = new Color(modelMaterials.techCube.dark.deep);
  const surfColor = new Color(modelMaterials.techCube.dark.surf);
  const foamColor = new Color(modelMaterials.techCube.dark.foam);
  ...
  $: if ($theme === "light") {
    deepColor.set(modelMaterials.techCube.light.deep);
    surfColor.set(modelMaterials.techCube.light.surf);
    foamColor.set(modelMaterials.techCube.light.foam);
    uniforms.uOpacity.value = 1.0;
    customMaterial.needsUpdate = true;
  } else {
    deepColor.set(modelMaterials.techCube.dark.deep);
    surfColor.set(modelMaterials.techCube.dark.surf);
    foamColor.set(modelMaterials.techCube.dark.foam);
