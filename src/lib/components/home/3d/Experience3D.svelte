<script lang="ts">
  ...
  const deepColor = new Color(modelMaterials.experience3D.dark.deep);
  const surfColor = new Color(modelMaterials.experience3D.dark.surf);
  const foamColor = new Color(modelMaterials.experience3D.dark.foam);
  ...
  $: if ($theme === "light") {
    deepColor.set(modelMaterials.experience3D.light.deep);
    surfColor.set(modelMaterials.experience3D.light.surf);
    foamColor.set(modelMaterials.experience3D.light.foam);
    uniforms.uOpacity.value = 1.0;
    customMaterial.needsUpdate = true;
  } else {
    deepColor.set(modelMaterials.experience3D.dark.deep);
    surfColor.set(modelMaterials.experience3D.dark.surf);
    foamColor.set(modelMaterials.experience3D.dark.foam);
