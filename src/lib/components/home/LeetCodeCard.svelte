...
<style>
  ...
  .leetcode-card:hover {
    border-color: #ffa116;
    box-shadow: 0 4px 20px rgba(255, 161, 22, 0.15);
  }
  ...
  .hero-card {
    background: linear-gradient(
      135deg,
      rgba(255, 161, 22, 0.12) 0%,
      rgba(255, 161, 22, 0.06) 100%
    );
  ...
  :global(.dark) .hero-card {
    background: linear-gradient(
      135deg,
      rgba(255, 161, 22, 0.18) 0%,
      rgba(255, 161, 22, 0.08) 100%
    );
