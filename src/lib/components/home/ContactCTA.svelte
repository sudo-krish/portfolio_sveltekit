...
>
    ...
    >
        ...
        >
            ...
            <!-- Terminal Container -->
            <div
                class="h-full rounded-xl border border-border bg-background/50 backdrop-blur-xl shadow-2xl flex flex-col overflow-hidden"
            >
                <!-- Terminal Header -->
                <div
                    class="flex items-center gap-2 px-4 py-3 bg-muted/40 border-b border-border/50"
                >
