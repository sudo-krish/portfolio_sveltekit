  ...
  <div class="content-wrapper">
    ...
    <div class="marquee-row opacity-30">
      <div class="marquee-inner">
        <span>DATA</span> <span class="stroke">ENGINEERING</span> <span class="sep">///</span>
        <span>CLOUD</span> <span class="stroke">NATIVE</span> <span class="sep">///</span>
        <span>DATA</span> <span class="stroke">ENGINEERING</span> <span class="sep">///</span>
        <span>CLOUD</span> <span class="stroke">NATIVE</span> <span class="sep">///</span>
      </div>
    </div>
    ...
    <div class="marquee-row opacity-60">
      <div class="marquee-inner">
        <span class="stroke">SYSTEM</span> <span>ARCHITECT</span> <span class="sep">+++</span>
        <span class="stroke">BIG</span> <span>DATA</span> <span class="sep">+++</span>
        <span class="stroke">SYSTEM</span> <span>ARCHITECT</span> <span class="sep">+++</span>
        <span class="stroke">BIG</span> <span>DATA</span> <span class="sep">+++</span>
      </div>
    </div>
    ...
    <div class="marquee-row opacity-40">
      <div class="marquee-inner">
        <span>PYTHON</span> <span class="stroke">SQL</span> <span class="sep">::</span>
        <span>KAFKA</span> <span class="stroke">SPARK</span> <span class="sep">::</span>
        <span>PYTHON</span> <span class="stroke">SQL</span> <span class="sep">::</span>
        <span>KAFKA</span> <span class="stroke">SPARK</span> <span class="sep">::</span>
      </div>
    </div>
