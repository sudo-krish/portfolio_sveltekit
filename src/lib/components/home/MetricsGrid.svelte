...
<div class="metrics-container relative">
  ...
  <div
    class="hidden lg:block absolute -left-8 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500/50 to-transparent"
  ></div>
  ...
  <header class="section-header">
    ...
    <div class="title-row">
      ...
      <Card
        class="stats-card border-blue-500/20 bg-background/50 backdrop-blur-xl"
      >
        <div class="stats-bar">
          <div class="stat-item">
