...
>
    <!-- Top Navigation -->
    <div
        class="relative z-40 w-full max-w-4xl mx-auto px-4 pt-20 sm:pt-24 pb-2 flex justify-between items-center"
    >
        <a
            href="/"
    ...
    <!-- The actual game component mounted cleanly -->
    <BattleGame {personal} />
</div>

<style>
    /* Scoped font class specifically for the Nav bar */
    .retro-font {
